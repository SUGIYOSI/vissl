...
#$ -l h_rt=16:00:00
#$ -j y
#$ -o /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/output__tsubame/experiment_01/finetuning/o.finetuning_simclr_resnet50_gaussian_blur_oneside_in1k_per10_to_cifar10__v1
...
python /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/vissl/run_distributed_engines.py \
    ...
    config.CHECKPOINT.DIR="/gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/train_result__tsubame/experiment_01/finetuning/finetuning_simclr_resnet50_gaussian_blur_oneside_in1k_per10_to_cifar10__v1" \
