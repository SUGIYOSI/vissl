...
#$ -j y
#$ -v USE_BEEOND=1
#$ -o /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/output__tsubame/experiment_01/pretrain/pretrain_simclr_resnet50_gaussian_blur_oneside_in1k_per10__v1
...
python -B /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/vissl/run_distributed_engines.py \
    hydra.verbose=true \
    config=/experiments/01/pretrain/simclr_resnet50_gaussian_blur__oneside.yaml \
    config.CHECKPOINT.DIR="/gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/train_result__tsubame/experiment_01/pretrain/pretrain_simclr_resnet50_gaussian_blur_oneside_in1k_per10__v1" \
