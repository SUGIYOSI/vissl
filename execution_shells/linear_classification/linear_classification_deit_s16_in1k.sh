...
#$ -j y
#$ -v USE_BEEOND=1
#$ -o /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/output__tsubame/linear_classification/deit_s16/o.linear_classification_dino_deit_s16_in1k_official_to_in1k__v1
...
python /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/vissl/run_distributed_engines.py \
    config=/benchmark/linear_image_classification/imagenet1k/linear_classification_deit_s16_to_in1k.yaml \
    config.CHECKPOINT.DIR="/gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/train_result__tsubame/linear_classification/deit_s16/linear_classification_dino_deit_s16_in1k_official_to_in1k__v1" \
