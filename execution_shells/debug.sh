...
#$ -l h_rt=00:10:00
#$ -j y
#$ -o /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/execution_shells/output/debug/v2/o.pretrain_simclr_deit_in1k_p100_node_4__v18
...
# source VISSL_py371_cu110_pyt171
# module list
...
python -B /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/run_distributed_engines.py \
    hydra.verbose=true \
    config=/pretrain/vision_transformer/simclr/simclr_deit_t16.yaml \
    config.CHECKPOINT.DIR="/gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/train_result/debug/other/v2/pretrain_simclr_deit_in1k_p100_node_4__v18" \
