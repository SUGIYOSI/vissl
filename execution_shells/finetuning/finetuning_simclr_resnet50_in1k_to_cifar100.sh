...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/execution_shells/output/finetuning/debug/o.finetuning_simclr_official_resnet50_in1k_ep200_to_cifar100__v1
...
python /gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/run_distributed_engines.py \
    hydra.verbose=true \
    config=benchmark/fulltune/cifar100/finetuning_simclr_resnet_to_cifar100.yaml \
    config.CHECKPOINT.DIR="/gs/hs0/tga-i/sugiyama.y.al/VISSL/vissl/train_result/debug/finetuning/finetuning_simclr_official_resnet50_in1k_ep200_to_cifar100__v1" \
